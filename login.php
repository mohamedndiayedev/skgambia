...
<img src="307.gif" class="center" width="300" height="200">
<div class="row">
	<div class="col s10 m2 l0"> 
		...
		<div class="panel panel-success"> 
			...
			<h1 id="col"><strong>Sky High Group Ltd. - Ultimate Dashboard</strong></h1>
			...
			<div class="panel-heading">
				...
				<?php if(sqlValue("select count(1) from membership_groups where allowSignup=1")){ ?>
					<h1 class="btn btn-success pull-right">SKY HIGH GROUP Ltd.<br/>A Gambian Real Estate Company</h1>
				<?php } ?>
