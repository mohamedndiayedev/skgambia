	...
	<div class="col-sm-6 col-lg-4">
		<div class="panel panel-success">
			...
			<div class="panel-heading">
				<h1 class="panel-title">ULTIMATE DASHBOARD - By ANK Analytics</h1>
				<?php if(sqlValue("select count(1) from membership_groups where allowSignup=1")){ ?>
					<h1 class="btn btn-success pull-right"><strong>SKY HIGH GROUP Ltd.<br/>A Gambian Real Estate Company</strong></h1>
				<?php } ?>
