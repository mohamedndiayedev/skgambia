...
<head>
	...
	<title>Sky High Ltd. | <?php echo (isset($x->TableTitle) ? $x->TableTitle : ''); ?></title>
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Sky High Gambia - A real estate Company -  You desire & We fulfill</a>
                </div>
              ...
              <li><a href="<?php echo PREPEND_PATH; ?>dashboard/adminprofile.php"><i class="fa fa-user"></i> <strong>My Profile Details</strong> </a></li>
