...
<div class="container-fluid">
        ...
        <h6 class="m-0 font-weight-bold text-primary">Edit BIF Reconciliation File</h6>
      </div>
<div class="card-body">
<?php
...
{
   $id = $_POST['edit_id'];
   $query = "SELECT * FROM brf WHERE id='$id' ";
    ...
    foreach($query_run as $row)
   {
    ...
    ?>
    <form action="update-brf.php" method="post">
        ...
        <div class="form-group">
         ...
         <a href="brf.php" class="btn btn-danger">Cancel</a>
         <button type="submit" name="updatebrf" class="btn btn-primary">Update</button>
   </form>
      <?php
    }
}
