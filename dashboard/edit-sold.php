...
session_start();
  ...
  include('includes/navbar-sold.php');
?>
...
{
   $id = $_POST['edit_id'];
   $query = "SELECT * FROM sold WHERE id='$id' ";
    ...
    foreach($query_run as $row)
   {
    ...
    ?>
    <form action="update-sold.php" method="post">
        ...
        <div class="form-group">
         ...
         <a href="sold.php" class="btn btn-danger">Cancel</a>
         <button type="submit" name="updatesold" class="btn btn-primary">Update</button>
   </form>
      <?php
    }
}
