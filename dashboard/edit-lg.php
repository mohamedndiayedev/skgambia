...
session_start();
  ...
  include('includes/navbar-lg.php');
?>
...
{
   $id = $_POST['edit_id'];
   $query = "SELECT * FROM lg WHERE id='$id' ";
    ...
    foreach($query_run as $row)
   {
    ...
    ?>
    <form action="update-lg.php" method="post">
        ...
        <div class="form-group">
         ...
         <a href="lg.php" class="btn btn-danger">Cancel</a>
         <button type="submit" name="update_lg" class="btn btn-primary">Update</button>
   </form>
      <?php
    }
}
