...
session_start();
  ...
  include('includes/navbar-grower.php');
?>
...
{
   $id = $_POST['edit_id'];
   $query = "SELECT * FROM grower WHERE id='$id' ";
    ...
    foreach($query_run as $row)
   {
    ...
    ?>
    <form action="update-grower.php" method="post">
        ...
        <div class="form-group">
         ...
         <a href="grower.php" class="btn btn-danger">Cancel</a>
         <button type="submit" name="update_grower" class="btn btn-primary">Update</button>
   </form>
      <?php
    }
}
