...
{
   $id = $_POST['edit_id'];
   $query = "SELECT * FROM reca WHERE id='$id' ";
    ...
    foreach($query_run as $row)
   {
    ...
    ?>
    <form action="update-reca.php" method="post">
        ...
        <div class="form-group">
                <label>Less: Uncleared Cheque<br/>Details:</label>
         ...
         <a href="reca.php" class="btn btn-danger">Cancel</a>
         <button type="submit" name="updatereca" class="btn btn-primary">Update</button>
   </form>
      <?php
    }
}
