...
session_start();
  ...
  include('includes/navbar-boiler.php');
?>
...
{
   $id = $_POST['edit_id'];
   $query = "SELECT * FROM boiler WHERE id='$id' ";
    ...
    foreach($query_run as $row)
   {
    ...
    ?>
    <form action="update-boiler.php" method="post">
        ...
        <div class="form-group">
         ...
         <a href="boiler.php" class="btn btn-danger">Cancel</a>
         <button type="submit" name="update_boiler" class="btn btn-primary">Update</button>
   </form>
      <?php
    }
}
