...
session_start();
  ...
  include('includes/navbar-brm.php');
?>
...
{
   $id = $_POST['edit_id'];
   $query = "SELECT * FROM brm WHERE id='$id' ";
    ...
    foreach($query_run as $row)
   {
    ...
    ?>
    <form action="update-brm.php" method="post">
        ...
        <div class="form-group">
         ...
         <a href="brm.php" class="btn btn-danger">Cancel</a>
         <button type="submit" name="updatebrm" class="btn btn-primary">Update</button>
   </form>
      <?php
    }
}
