...
{
   $id = $_POST['edit_id'];
   $query = "SELECT * FROM finisher WHERE id='$id' ";
    ...
    foreach($query_run as $row)
   {
    ...
    ?>
    <form action="update-finisher.php" method="post">
        ...
        <div class="form-group">
         ...
         <a href="finisher.php" class="btn btn-danger">Cancel</a>
         <button type="submit" name="update_finisher" class="btn btn-primary">Update</button>
   </form>
      <?php
    }
}
