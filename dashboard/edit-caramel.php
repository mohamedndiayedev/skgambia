...
session_start();
  ...
  include('includes/navbar-caramel.php');
?>
...
{
   $id = $_POST['edit_id'];
   $query = "SELECT * FROM caramel WHERE id='$id' ";
    ...
    foreach($query_run as $row)
   {
    ...
    ?>
    <form action="update-caramel.php" method="post">
        ...
        <div class="form-group">
         ...
         <a href="caramel.php" class="btn btn-danger">Cancel</a>
         <button type="submit" name="updatecaramel" class="btn btn-primary">Update</button>
   </form>
      <?php
    }
}
