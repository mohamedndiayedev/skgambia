...
session_start();
  ...
  include('includes/navbar-sugar.php');
?>
...
{
   $id = $_POST['edit_id'];
   $query = "SELECT * FROM sugar WHERE id='$id' ";
    ...
    foreach($query_run as $row)
   {
    ...
    ?>
    <form action="update-sugar.php" method="post">
        ...
        <div class="form-group">
         ...
         <a href="sugar.php" class="btn btn-danger">Cancel</a>
         <button type="submit" name="updatesugar" class="btn btn-primary">Update</button>
   </form>
      <?php
    }
}
