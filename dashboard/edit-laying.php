...
session_start();
  ...
  include('includes/navbar-laying.php');
?>
...
{
   $id = $_POST['edit_id'];
   $query = "SELECT * FROM laying WHERE id='$id' ";
    ...
    foreach($query_run as $row)
   {
    ...
    ?>
    <form action="update-laying.php" method="post">
        ...
        <div class="form-group">
         ...
         <a href="laying.php" class="btn btn-danger">Cancel</a>
         <button type="submit" name="update_laying" class="btn btn-primary">Update</button>
   </form>
      <?php
    }
}
