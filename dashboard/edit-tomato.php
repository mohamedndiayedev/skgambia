...
{
   $id = $_POST['edit_id'];
   $query = "SELECT * FROM tomato WHERE id='$id' ";
    ...
    foreach($query_run as $row)
   {
    ...
    ?>
    <form action="update-tomato.php" method="post">
        ...
        <div class="form-group">
         ...
         <a href="tomato.php" class="btn btn-danger">Cancel</a>
         <button type="submit" name="updatetomato" class="btn btn-primary">Update</button>
   </form>
      <?php
    }
}
