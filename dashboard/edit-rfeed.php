...
session_start();
  ...
  include('includes/navbar-rfeed.php');
?>
...
{
   $id = $_POST['edit_id'];
   $query = "SELECT * FROM rfeed WHERE id='$id' ";
    ...
    foreach($query_run as $row)
   {
    ...
    ?>
    <form action="update-rfeed.php" method="post">
        ...
        <div class="form-group">
         ...
         <a href="rfeed.php" class="btn btn-danger">Cancel</a>
         <button type="submit" name="update_rfeed" class="btn btn-primary">Update</button>
   </form>
      <?php
    }
}
