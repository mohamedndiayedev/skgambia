...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<head>
		...
		<title>SKY HIGH GROUP Ltd. | ULTIMATE DASHBOARD</title>
		<link id="browser_favicon" rel="shortcut icon" href="<?php echo PREPEND_PATH; ?>resources/images/fav.png">
...
<!-- 		<link rel="stylesheet" href="<?php echo PREPEND_PATH; ?>resources/select2/select2.css" media="screen">
 ...
 -->
	...
	<body>
		<div class="container theme-cosmo theme-compact">
			...
			<?php if(function_exists('htmlUserBar'))  ?>   
				<div style="height: 200px;" class="hidden-print" ></div>
			<?php } ?>
    ...
    <div class="navbar-header">
      ...
      &nbsp;
      <div class="btn-group">    
        <a href="#" class="btn btn-default navbar-btn dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-chevron-down"></i> <span class="hidden-xs">Sky High Ltd.</span></a>
  ...
  <div class="navbar-center navbar-brand" href="#"><strong><a class="navbar-brand">Office Based & Remote Working System</a></strong></div>
				<marquee><strong><h3 id="color">A Gambian Real Estate Company<h3></strong></marquee><br>
					
					<style>
						#cov {color:#E44D26;};
					</style>
					<strong><h3 id="cov">Covid-19 Alert: Protect Yourself and People Around You !</h3></strong>
