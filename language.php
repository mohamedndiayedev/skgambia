<?php
	...
	$Translation['login failed']="You are not authorized to access the Sky High System. Please, contact the Admin.";
	$Translation['sign in here']="Sign In Here";
	$Translation['remember me']="Remember me";
	$Translation['username']="Login admin";
